...
\begin{figure}%[!h]
    \centering
\begin{tikzpicture}
    \umlclass[contentfill, rectangle split parts=2, type=Blob]{3ac7d980…}{%
      +data = \\
...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
    \umlclass[directoryfill, rectangle split parts=2, type=Directory]{7178d6cc…}{%
      +entries = \\
      \quad \texttt{doc/}\\
    ...
    \umlsimpleclass[contentfill, type=Blob, right=1.5cm of 7178d6cc…]{da960397…}
    \umlsimpleclass[directoryfill, type=Directory, above=0.3cm of da960397…]{b97c9c58…}
    \umlsimpleclass[contentfill, type=Blob, below=0.3cm of da960397…]{a1a3772c…}
...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
    \umlclass[revisionfill, rectangle split parts=2, type=Revision]{9215efc5…}{%
    ...
    \umlsimpleclass[directoryfill, type=Directory, right=1.5cm of 9215efc5…]{c54d14d1…}
    \umlsimpleclass[revisionfill, type=Revision, below=1cm of 9215efc5….south west, anchor=west]{f0df6963…}
...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
    \umlclass[releasefill, rectangle split parts=2, type=Release]{e05dae84…}{%
    ...
    \umlsimpleclass[revisionfill, type=Revision, right=1.5cm of e05dae84…]{3afc8cb8…}
...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
    \umlclass[snapshotfill, rectangle split parts=2, type=Snapshot]{acf6b31f…}{%
      +entries = \\
      \quad \texttt{HEAD}\\
    ...
    \umlsimpleclass[revisionfill, type=Revision, right=1.5cm of acf6b31f…]{cdcb9c35…}
    \umlsimpleclass[revisionfill, type=Revision, above=0.3cm of cdcb9c35…]{fd262af8…}
    \umlsimpleclass[releasefill, type=Release, below=0.3cm of cdcb9c35…]{84d3a02f…}
