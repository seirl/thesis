...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
        \umlobj[contentfill]{Blob}{3ac7d980…}{%
            +data = \\
...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
    \umlobj[directoryfill]{Directory}{7178d6cc…}{%
      +entries = \\
      \quad \texttt{doc/}\\
...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
    \umlobj[revisionfill]{Revision}{9215efc5…}{%
...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
    \umlobj[releasefill]{Release}{e05dae84…}{%
...
\begin{figure}%[!h]
    \centering
    \begin{tikzpicture}
    \umlobj[snapshotfill]{Snapshot}{acf6b31f…}{%
      +entries = \\
      \quad \texttt{HEAD}\\
