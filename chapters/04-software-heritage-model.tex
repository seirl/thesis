...
\item \emph{History layer}: subset of the full corpus consisting of revision and
  release nods only, and edges between them
...
These identifiers were introduced in~\cite{cise-2020-doi} and are documented in
the Software Heritage development
