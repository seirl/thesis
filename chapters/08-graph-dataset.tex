...
Dataset}, a graph representation of all source code artifacts archived by
...
Moreover, in the event that the export is suddenly interrupted (e.g., in case
of a power failure), export clients must be able to resume the export even as
they might not have acknowledged their current progress in the stream to the
journal server.
...
the total number of that year's revisions (see \cref{lst:weekend-work}).
