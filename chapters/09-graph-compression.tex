...
\cref{fig:compression-indegree}) has a fatter tail than the outdegree
...
of how long a single traversal takes. \Cref{tab:compression-bfs-benchmark}
...
The cumulative distribution of \cref{fig:compression-distrib-rev-ori} measure
