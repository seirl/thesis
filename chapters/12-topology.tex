...
A recent work by \textcite{trujillo2021penumbra} highlighted
...
consisting of degenerate strings of commits. \Cref{fig:shortestpath_rev} shows
...
\begin{figure}
    \begin{subfigure}{.55\textwidth}
        \centering
        \input{tikz/figures/topology-summary-filesystem.tikz}
        \caption{Filesystem layer}%
        \label{fig:topology-summary-filesystem}
    \end{subfigure}\hfill%
    \begin{subfigure}{.40\textwidth}
        \centering
        \input{tikz/figures/topology-summary-revision.tikz}
        \caption{Commit layer}%
