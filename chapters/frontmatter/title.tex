...
\includegraphics[align=c, height=1.8cm]{img/frontmatter/uni_paris.pdf}  \hfill
\includegraphics[align=c, height=1.0cm]{img/frontmatter/inria.pdf} \hfill
\includegraphics[align=c, width=5cm]{img/frontmatter/SWH-logo}
