...
...
    ...
    \begin{frame}
        \pdfpcnote{%
            ...
            nodes that are interconnected together but completely isolated from the
            ...
            then just analyze each component on a separate machine.
            \\\\
            Well, it turns out that this is not the case at all, at least for
            the filesystem layer. more than 97\% of all the nodes are
    ...
    \begin{frame}
        ...
        \pdfpcnote{%
            ...
            topological properties. This sort of confirms our intuitions of
            what the layers look like, but experimentally.
            \\\\
